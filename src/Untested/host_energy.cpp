...
/* **************************** events  callback *************************** */
void (*on_creation_ptr)(simgrid::s4u::Host&);
...
static void on_creation(simgrid::s4u::Host& host)
{
  ...
  on_creation_ptr = on_creation;
}

void (*on_action_state_change_ptr)(simgrid::kernel::resource::CpuAction const& action,
                                   ...
                                   simgrid::kernel::resource::Action::State /*previous*/)
{
  ...
  on_action_state_change_ptr = on_action_state_change;
}

void (*on_host_change_ptr)(simgrid::s4u::Host const&);
...
static void on_host_change(simgrid::s4u::Host const& h)
{
  ...
  on_host_change_ptr = on_host_change;
}

void (*on_host_destruction_ptr)(simgrid::s4u::Host const&);
static void on_host_destruction(simgrid::s4u::Host const& host)
{
  ...
  on_host_destruction_ptr = on_host_destruction;
}
